...
impl Discover {
    ...
    pub fn setup_top_picks(&self, song_list: Vec<SongList>) {
        ...
        SongListGridItem::box_update_songlist(top_picks.clone(), &song_list, 180, false, &sender);
    ...
    pub fn setup_new_albums(&self, song_list: Vec<SongList>) {
        ...
        SongListGridItem::box_update_songlist(new_albums.clone(), &song_list, 180, true, &sender);
